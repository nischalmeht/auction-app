    ...
    return (
        ...
        <>
            ...
            <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
                <div className="bg-white w-full max-w-screen-2xl mx-auto px-8 py-8 flex flex-col gap-6 items-center rounded-lg ">
                    <h1
              ...
              <div className="flex flex-col sm:flex-1">
                ...
                <input
                  ...
                  className="text-[16px] py-2 w-full bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none"
                />
              </div>
              <div className="flex flex-col sm:flex-1">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  ...
                  >
                    ...
                    <option value="KMB">Kotal Mahindra Bank</option>
